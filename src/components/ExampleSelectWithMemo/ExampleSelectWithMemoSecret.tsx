import {SelectWithMemo} from "../../App";
import React, {KeyboardEvent, useState} from "react";
import s from "../Select/Select.module.css";

type ExampleSelectWithMemoPropsType = {
    selectData: SelectWithMemo[]
    value: string;
    setSelectValue: (value: string) => void;
}

export const ExampleSelectWithMemoSecret = (props: ExampleSelectWithMemoPropsType) => {
